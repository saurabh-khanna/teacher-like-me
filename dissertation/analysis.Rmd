...
# df_stu %>% 
#   select(univcode, gender) %>% 
#   mutate(
#     gender = as.integer(gender),
#     female = gender - 1
#   ) %>%
#   group_by(univcode) %>% 
#   summarise(female_perc = mean(female, na.rm = TRUE)) %>% 
#   arrange(-female_perc)
# 
# 
# df_stu %>% 
#   filter(univcode %in% c("IR024", "IR036")) %>% 
#   tabyl(univcode, grade)
# 
# df_grades %>% 
#   distinct(stdid, .keep_all = T) %>%
#   transmute(univcode = substr(department_id, 1, 5)) %>% 
#   count(univcode)
```
...
df_grades %>%
  ...
  pivot_longer(cols = contains("score"), values_drop_na = T, names_to = "testtype", values_to = "b_hot_score") %>%
  lm_robust(b_hot_score ~ reservation_fac + factor(testtype), data = ., fixed_effects = ~ fe_var, se_type = "stata", clusters = facid) %>%
  knitreg(include.ci = F, digits = 3, stars = c(0.01, 0.05, 0.1))
```
...
lm1.2a <-
  ...
  mutate(fe_var = str_c(department_id, course_name, sep = "_")) %>%
  lm_robust(course_rank ~ collaboration_read + reservation_fac, data = ., fixed_effects = ~ stdid + fe_var, se_type = "stata", clusters = facid)
...
lm1.2b <-
  ...
  mutate(fe_var = str_c(department_id, course_name, sep = "_")) %>%
  lm_robust(course_rank ~ collaboration_read + reservation_fac + fac_associate_professor + fac_professor + fac_yearsinhighed, data = ., fixed_effects = ~ stdid + fe_var, se_type = "stata", clusters = facid)
...
lm1.2c <-
  ...
  mutate(fe_var = str_c(department_id, course_name, sep = "_")) %>%
  lm_robust(course_rank ~ collaboration_read + reservation_fac + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite, data = ., fixed_effects = ~ stdid + fe_var, se_type = "stata", clusters = facid)
...
lm1.2d <-
  ...
  mutate(fe_var = str_c(department_id, course_name, sep = "_")) %>%
  lm_robust(course_rank ~ collaboration_read + reservation_fac + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite + fac_female, data = ., fixed_effects = ~ stdid + fe_var, se_type = "stata", clusters = facid)
...
lm1.2e <-
  ...
  mutate(fe_var = str_c(department_id, course_name, sep = "_")) %>%
  lm_robust(course_rank ~ collaboration_read + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite + fac_female, data = ., fixed_effects = ~ stdid + fe_var, se_type = "stata", clusters = facid)

knitreg(list(lm1.2a, lm1.2b, lm1.2c, lm1.2d, lm1.2e), custom.note = "%stars", stars = c(0.01, 0.05, 0.1), include.ci = FALSE, custom.model.names = c("I", "II", "III", "IV", "V"), dcolumn = TRUE, booktabs = TRUE, float.pos = "H", caption = "", digits = 2, include.nclust = F, include.rsquared = F, include.adjrs = F, include.rmse = F, custom.coef.names = c("Read Literature", "Reservation faculty", "Associate professor", "Professor", "Experience in years", "Highest degree is PhD", "Highest degree is PhD in progress", "Degree college elite", "Female"))
```
...
## New combo regressions [6-6-2023]
...
lm3 <-
  ...
  mutate_at(vars(efac_pub_sci, efac_pub_ei, efac_pub_ssci), ~ replace_na(., 0)) %>% 
  mutate(
    efac_pub_intl = efac_pub_intl/3,
    efac_pub_intl = if_else(efac_pub_intl > 30, 30, efac_pub_intl),
...
texreg(list(lm1, lm2, lm3, lm4, lm5), custom.note = "%stars", stars = c(0.01, 0.05, 0.1), include.ci = FALSE, dcolumn = TRUE, booktabs = TRUE, float.pos = "H", caption = "", digits = 2, include.nclust = F, include.rsquared = F, include.adjrs = F, include.rmse = F, custom.model.names = c("I", "II", "III", "IV", "V"), custom.coef.names = c("Reservation faculty", "Associate professor", "Professor", "Experience in years", "Highest degree is PhD", "Highest degree is PhD in progress", "Degree college elite", "Female"))
```
...
lm_pub1 <-
  facdata_mentions %>%
  left_join(read_dta(here::here("data/efac_new_controls.dta")) %>% select(facid, efac_pub_sci), by = "facid") %>% 
  mutate(
    efac_pub_sci = efac_pub_sci/3,
    univcode = str_sub(department_id, 1, 5),
    majtype = str_sub(department_id, 6, 7),
  ) %>%
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_sci ~ fac_reservation, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub2 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_sci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub3 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_sci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub4 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_sci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite + fac_female, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub1 <-
  facdata_mentions %>%
  left_join(read_dta(here::here("data/efac_new_controls.dta")) %>% select(facid, efac_pub_ei), by = "facid") %>% 
  mutate(
    efac_pub_ei = efac_pub_ei/3,
    univcode = str_sub(department_id, 1, 5),
    majtype = str_sub(department_id, 6, 7),
  ) %>%
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ei ~ fac_reservation, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub2 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ei ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub3 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ei ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub4 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ei ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite + fac_female, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub1 <-
  facdata_mentions %>%
  left_join(read_dta(here::here("data/efac_new_controls.dta")) %>% select(facid, efac_pub_ssci), by = "facid") %>% 
  mutate(
    efac_pub_ssci = efac_pub_ssci/3,
    univcode = str_sub(department_id, 1, 5),
    majtype = str_sub(department_id, 6, 7),
  ) %>%
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ssci ~ fac_reservation, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub2 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ssci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub3 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ssci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)
...
lm_pub4 <-
  ...
  left_join(read_csv("/Users/saurabh/Everything/GitHub/teacher-like-me/data/depweights.csv"), by = "department_id") %>%
  lm_robust(efac_pub_ssci ~ fac_reservation + fac_associate_professor + fac_professor + fac_yearsinhighed + fac_highest_degree_phd + fac_highest_degree_phd_in_prog + fac_degree_college_elite + fac_female, data = ., se_type = "stata", weights = sw_f, fixed_effects = ~ univcode + majtype)

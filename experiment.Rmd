...
knitreg(list(lm_fe1, lm_fe2, lm_fe3), custom.note = "%stars \n HC1 standard errors used.", stars = c(0.01, 0.05, 0.1), include.ci = FALSE, custom.model.names = c("Student FE", "Student and course FE", "Student and classroom FE"), dcolumn = TRUE, booktabs = TRUE, float.pos = "h", caption = "")
```
